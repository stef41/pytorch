...
def is_target_div_by_dim(target: list[int], dim: DVar | Prod) -> BinConstraintD:
    """
...
def is_dim_div_by_target(target: list[int], dim: DVar | Prod) -> BinConstraintD:
    """
...
def gen_all_reshape_possibilities(
    list_of_dims: list[DVar], target: list[int]
) -> Constraint:
    """
